<template>
  <main>
    <InfoPersonajes :datosRyM="datosRyM"/>
  </main>
</template>

<script>
import InfoPersonajes from './mainComponents/InfoPersonaje.vue';
  ...
  data() {
    return {
      datosRyM: [
        ...
        {name: 'Abadango Cluster Princess', image: 'https://rickandmortyapi.com/api/character/avatar/6.jpeg'},
      ]
    }
  },
}
